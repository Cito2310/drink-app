...
export const MenuNew = () => {
    ...
    const onSubmit = async(e) => {
        ...
        if (!error) {
            ...
            axios.post("https://drink-freeze.herokuapp.com/api/product/", payload)
                .then(() => {
    ...
    return (
        ...
        <div className="modal-content animate__animated animate__fadeInDownBig">
            ...
            <div id="footer-modal">
                <input type="submit" onClick={onSubmit} className="btn btn-primary" value="Crear"/>
                {(requestHttp.loading) ?    <label><div class="lds-dual-ring"></div></label>                                                         : null}
